...
$allow = array('block','brick','kerbs','slabs','drains','pavers');
if ( !in_array($pg, $allow) ) {
    $pg = NULL;
}
?>
    <section class="gallery-section clearfix">
        <div class="gallery-item gallery-item1  gallery-kerb">
            <div class="kerb-gallery-img">
                <img data-src="img/block.png" alt="block">
                <p>blocks</p>
            </div>
        </div>
        <div class="gallery-slider">
            <div class="gallery__carousel owl-carousel owl-theme">
                <div class="gallery">
                    <a  class="gallery-item block-btn">
                        <img data-src="img/gallery2.jpg" alt="gallery2">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
                        </div>
                    </a>
                </div>
                 <div class="gallery">
                    <a class="gallery-item" href="more-product.php?page=block">
                        <img data-src="img/kerb.jpg" alt="gallery3">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
                        </div>
                ...
                <div class="gallery">
                    <a class="gallery-item" href="more-product.php?page=block">
                        <img data-src="img/gallery1.jpg" alt="gallery2">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
                        </div>
                 ...
                 <div class="gallery">
                    <a class="gallery-item" href="more-product.php?page=block">
                        <img data-src="img/gallery4.jpg" alt="gallery3">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
                        </div>
    ...
    <!-- paver -->
    <section class="gallery-section gallery-section-paver clearfix">
         <div class="gallery-item gallery-paver  gallery-kerb">
            <div class="kerb-gallery-img">
                <img data-src="img/paver.png" alt="gallery1">
                <p>pavers</p>
            </div>
        </div>
        <div class="gallery-slider gallery-paver">
            <div class="gallery__carousel owl-carousel owl-theme">
                <div class="gallery">
                    <a  class="gallery-item paver-btn">
                        <img data-src="img/gallery5.jpg" alt="gallery2">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
                        </div>
                ...
                <div class="gallery">
                    <a href="more-product.php?page=paver" class="gallery-item">
                        <img data-src="img/gallery6.jpg" alt="gallery3">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <a href="#" class="arrow"><img data-src="img/arrow.png" alt="arrow"></a>
                        </div>
    ...
    <section class="gallery-section clearfix">
        <div class="gallery-item gallery-item1  gallery-kerb">
            <div class="kerb-gallery-img">
                <img data-src="img/kerb.png" alt="gallery1">
                <p>kerbs</p>
            </div>
        </div>
        <div class="gallery-slider">
    ...
    <section class="gallery-section gallery-section-paver clearfix">
           <div class="gallery-item gallery-paver  gallery-kerb">
            <div class="kerb-gallery-img">
                <img data-src="img/slab.png" alt="gallery1">
                <p>slabs</p>
            </div>
        </div>
        <div class="gallery-slider gallery-paver">
            <div class="gallery__carousel owl-carousel owl-theme">
                ...
                <div class="gallery">
                    <a class="gallery-item" href="more-product.php?page=slabs">
                        <img data-src="img/gallery6.jpg" alt="gallery3">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
    ...
    <section class="gallery-section clearfix">
        <div class="gallery-item gallery-item1  gallery-kerb">
            <div class="kerb-gallery-img">
                <img data-src="img/drain.png" alt="gallery1">
                <p>drains</p>
            </div>
        </div>
        <div class="gallery-slider">
            <div class="gallery__carousel owl-carousel owl-theme">
                <div class="gallery">
                    <a class="gallery-item drain-btn">
                        <img data-src="img/gallery2.jpg" alt="gallery2">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
                ...
                <div class="gallery">
                    <a class="gallery-item" href="more-product.php?page=drains">
                        <img data-src="img/kerb.jpg" alt="gallery3">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
    ...
    <section class="gallery-section gallery-section-paver clearfix">
         <div class="gallery-item gallery-paver  gallery-kerb">
            <div class="kerb-gallery-img">
                <img data-src="img/brick.png" alt="gallery1">
                <p>bricks</p>
            </div>
        </div>
        <div class="gallery-slider gallery-paver">
            <div class="gallery__carousel owl-carousel owl-theme">
                <div class="gallery">
                    <a class="gallery-item brick-btn">
                        <img data-src="img/gallery5.jpg" alt="gallery2">
                        <div class="arrow-text clearfix">
                            <p>Paving Blocks</p>
                            <div class="arrow"><img data-src="img/arrow.png" alt="arrow"></div>
